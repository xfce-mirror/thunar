                                     ...
                                     gboolean    multiple_files)
{
  ...
  thunar_file_request_thumbnail (dst_file, thunar_icon_size_to_thumbnail_size (48 * scale_factor), THUNAR_THUMBNAIL_PURPOSE_DIALOG);
  ...
  thunar_file_request_thumbnail (src_file, thunar_icon_size_to_thumbnail_size (48 * scale_factor), THUNAR_THUMBNAIL_PURPOSE_DIALOG);
