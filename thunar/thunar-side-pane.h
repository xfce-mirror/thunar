...
struct _ThunarSidePaneIface
{
  ...
  /* methods */
  ThunarFile *(*get_current_directory)  (ThunarSidePane *pane);
  void        (*set_current_directory)  (ThunarSidePane *pane,
                                         ThunarFile     *current_directory);
};

GType       thunar_side_pane_get_type               (void) G_GNUC_CONST;

ThunarFile *thunar_side_pane_get_current_directory  (ThunarSidePane *pane);
void        thunar_side_pane_set_current_directory  (ThunarSidePane *pane,
                                                     ThunarFile     *current_directory);
