 ...
 **/
static gchar *
thunar_util_get_statusbar_text_for_files (ThunarStandardViewModel *model,
                                          GList                   *files,
...
/**
 * thunar_util_get_statusbar_text:
 ...
 **/
gchar *
thunar_util_get_statusbar_text (ThunarStandardViewModel *model,
