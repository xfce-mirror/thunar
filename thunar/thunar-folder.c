                       ...
                       gpointer          user_data)
{
  ...
  GList         list;
 // GList        *files_to_reload_content_type = NULL; //TODO: Figure out when to reload
 // gboolean      reload_content_types = TRUE;
  ...
  /* check if we need to load the content type of some files */
  //if (files_to_reload_content_type)
  //  thunar_folder_load_content_types (folder, files_to_reload_content_type);
}
