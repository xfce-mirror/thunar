                                   ...
                                   ThunarWindow *window)
{
  ...
  g_signal_connect (G_OBJECT (page), "notify::searching", G_CALLBACK (thunar_window_notify_loading), window);
...
thunar_window_action_stop_search (ThunarWindow *window)
{
  ...
  if (thunar_standard_view_get_searching (THUNAR_STANDARD_VIEW (window->view)))
                              ...
                              ThunarWindow *window)
{
  ...
  if (gtk_widget_get_realized (GTK_WIDGET (window))
      && window->view == GTK_WIDGET (view))
    {
      ...
      if (thunar_view_get_loading (view) || thunar_standard_view_get_searching (THUNAR_STANDARD_VIEW (view)))
        {
