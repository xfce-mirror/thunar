...
struct _ThunarWindow
{
  ...
  GtkWidget              *trash_infobar_release;
...
thunar_window_init (ThunarWindow *window)
{
  ...
  gtk_container_set_border_width (GTK_CONTAINER (window->trash_infobar), 0);
  gtk_grid_attach (GTK_GRID (window->view_box), window->trash_infobar, 0, 0, 1, 1);
  window->trash_infobar_release = gtk_info_bar_add_button (GTK_INFO_BAR (window->trash_infobar), "Restore", 1);
  gtk_info_bar_add_button (GTK_INFO_BAR (window->trash_infobar), "Empty", 0);
  ...
  g_signal_connect_swapped (G_OBJECT (window->launcher),
                    "selection-changed-in-trash",
                    G_CALLBACK (thunar_window_trash_selection_updated),
                    window);
                                     ...
                                     ThunarFile   *current_directory)
{
  ...
  is_trash ? gtk_widget_show(window->trash_infobar) : gtk_widget_hide(window->trash_infobar);
 ...
 **/
static void
thunar_window_trash_selection_updated (ThunarWindow *window, gboolean sensitive)
{
  gtk_widget_set_sensitive (window->trash_infobar_release, sensitive);
}
