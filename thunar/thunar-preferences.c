...
thunar_preferences_class_init (ThunarPreferencesClass *klass)
{
  ...
  /**
   * ThunarPreferences:sorting-smart-filenames:
   *
   * Whether to use smart (natural) sorting for filenames.
   **/
  preferences_props[PROP_SORTING_SMART_FILENAMES] =
  g_param_spec_boolean ("sorting-smart-filenames",
