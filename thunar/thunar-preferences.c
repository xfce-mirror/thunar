 ...
 **/
  ...
  /**
   * ThunarPreferences:misc-highlight-color
   *
   * If true, displays the context menu option to set a highlight color for that file.
   **/
  preferences_props[PROP_MISC_HIGHLIGHT_COLOR] =
      g_param_spec_boolean ("misc-highlight-color",
                            "MiscHighlightColor",
                            NULL,
                            TRUE,
                            EXO_PARAM_READWRITE);
