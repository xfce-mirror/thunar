  ...
  switch (job_operation->operation_kind)
    ...
    case THUNAR_JOB_OPERATION_KIND_UNLINK:
      ...
      if (thunar_file_list == NULL)
        ...
        {
          operation_canceled = thunar_application_unlink_files (application, NULL, thunar_file_list, TRUE, THUNAR_UNLINK_FILES_WARN_ALWAYS, THUNAR_OPERATION_LOG_OPERATIONS);
