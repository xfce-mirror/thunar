...
#ifndef __THUNAR_LOCAL_FILE_H__
#define __THUNAR_LOCAL_FILE_H__

#include <thunar/thunar-file.h>

G_BEGIN_DECLS;

typedef struct _ThunarLocalFileClass ThunarLocalFileClass;
typedef struct _ThunarLocalFile      ThunarLocalFile;

#define THUNAR_TYPE_LOCAL_FILE            (thunar_local_file_get_type ())
...
#define THUNAR_IS_LOCAL_FILE_CLASS(klass) (G_TYPE_INSTANCE_GET_CLASS ((obj), THUNAR_TYPE_LOCAL_FILE, ThunarLocalFileClass))
