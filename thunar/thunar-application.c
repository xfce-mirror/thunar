...
static void
hash_table_show_and_select (GHashTable *restore_open_table)
{
  ThunarApplication *application = thunar_application_get();
  g_hash_table_foreach (restore_open_table, hash_table_entry_show_and_select_files, application);
                                  ...
                                  gboolean           open_original_folder)
{
  ...
  GClosure    *restore_show_closure = NULL;
  ...
  if (open_original_folder)
    {
      ...
      restore_show_closure = g_cclosure_new_swap (G_CALLBACK (hash_table_show_and_select), restore_open_table, NULL);
      new_files_closure = restore_show_closure;
    }
