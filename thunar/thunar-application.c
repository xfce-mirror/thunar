          ...
          if (tabs_left != NULL && g_strv_length (tabs_left) > 0)
            {
              ...
              g_object_get (G_OBJECT (application->preferences), "last-focused-tab-left", &tab, NULL);
              thunar_window_notebook_set_current_tab (window, tab);
              has_left_tabs = TRUE;
            }
          ...
          if (tabs_right != NULL && g_strv_length (tabs_right) > 0)
            {
              ...
              thunar_window_notebook_remove_tab (window, 0); /* remove automatically opened tab */
              g_object_get (G_OBJECT (application->preferences), "last-focused-tab-right", &tab, NULL);
              thunar_window_notebook_set_current_tab (window, tab);
            }
