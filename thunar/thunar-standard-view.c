...
{
  ThunarThumbnailer *thumbnailer = thunar_thumbnailer_get ();
  ...
  g_object_bind_property (G_OBJECT (standard_view->icon_renderer), "size", G_OBJECT (thumbnailer), "thumbnail-size", G_BINDING_SYNC_CREATE);
...
thunar_standard_view_row_changed (ThunarStandardViewModel *model,
                                  ...
                                  ThunarStandardView      *standard_view)
{
  /* previously was used for to request thumbnails */
}
