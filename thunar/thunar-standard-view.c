...
static XfceGtkActionEntry thunar_standard_view_action_entries[] =
{
    ...
    { THUNAR_STANDARD_VIEW_ACTION_SORT_BY_DTIME,      "<Actions>/ThunarStandardView/sort-by-dtime",      "",           XFCE_GTK_RADIO_MENU_ITEM, N_ ("By Deletion _Date"),     N_ ("Keep items sorted by their deletion date"),          NULL, G_CALLBACK (thunar_standard_view_action_sort_by_date_deleted), },
                                        ...
                                        GtkAccelGroup      *accel_group)
{
  ...
  if (standard_view->showSortByDateDeleted)
