...
static gboolean
thunar_launcher_action_cut_editable (GtkWidget *focused_widget)
{
  _thunar_return_val_if_fail (GTK_IS_EDITABLE (focused_widget), FALSE);
...
static gboolean
thunar_launcher_action_copy_editable (GtkWidget *focused_widget)
{
  _thunar_return_val_if_fail (GTK_IS_EDITABLE (focused_widget), FALSE);
...
static gboolean
thunar_launcher_action_paste_editable (GtkWidget *focused_widget)
{
  _thunar_return_val_if_fail (GTK_IS_EDITABLE (focused_widget), FALSE);
        ...
        if (focused_widget && GTK_IS_EDITABLE (focused_widget))
          {
            item = xfce_gtk_image_menu_item_new_from_icon_name (
                          ...
                          action_entry->accel_path, G_CALLBACK (thunar_launcher_action_cut_editable),
        ...
        if (focused_widget && GTK_IS_EDITABLE (focused_widget))
          {
            item = xfce_gtk_image_menu_item_new_from_icon_name (
                          ...
                          action_entry->accel_path,G_CALLBACK (thunar_launcher_action_copy_editable),
                          G_OBJECT (focused_widget), action_entry->menu_item_icon_name, menu);
        ...
        if (focused_widget && GTK_IS_EDITABLE (focused_widget))
          {
            item = xfce_gtk_image_menu_item_new_from_icon_name (
                          ...
                          action_entry->accel_path,G_CALLBACK (thunar_launcher_action_paste_editable),
                          G_OBJECT (focused_widget), action_entry->menu_item_icon_name, menu);
