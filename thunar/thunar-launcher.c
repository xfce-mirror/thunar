...
static XfceGtkActionEntry thunar_launcher_action_entries[] =
{
    ...
    { THUNAR_LAUNCHER_ACTION_SENDTO_SHORTCUTS, "<Actions>/ThunarShortcutsPane/sendto-shortcuts",   "",                  XFCE_GTK_IMAGE_MENU_ITEM, N_ ("Create _Bookmark"),                N_ ("Create bookmarks for the selected folders, in the sidepane. If no folders are selected the current one is used."), "bookmark-new", G_CALLBACK (thunar_launcher_action_add_shortcuts), },
