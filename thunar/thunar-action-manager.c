...
static XfceGtkActionEntry thunar_action_manager_action_entries[] =
{
    ...
    { THUNAR_ACTION_MANAGER_ACTION_PASTE_LINK,        NULL,                                                  "",                  XFCE_GTK_IMAGE_MENU_ITEM, N_ ("_Paste Link"),         N_ ("Create link to files previously selected by a Cut or Copy command"), "edit-paste",           G_CALLBACK (thunar_action_manager_action_paste_link),   },
