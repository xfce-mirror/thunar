...
static XfceGtkActionEntry thunar_action_manager_action_entries[] =
{
    ...
    { THUNAR_ACTION_MANAGER_ACTION_UNDO,             "<Actions>/ThunarActionManager/undo",                   "<Primary>Z",        XFCE_GTK_IMAGE_MENU_ITEM, N_ ("_Undo"),                           N_ ("Undo the latest operation"),                                                               "user-undo",             G_CALLBACK (thunar_action_manager_action_undo),                },
