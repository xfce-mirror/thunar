...
thunar_preferences_dialog_init (ThunarPreferencesDialog *dialog)
{
  ...
  button = gtk_check_button_new_with_mnemonic (_("Symbolic Icons"));
  g_object_bind_property (G_OBJECT (dialog->preferences),
                          "misc-symbolic-icons-in-sidepane",
                          G_OBJECT (button),
                          "active",
                          G_BINDING_BIDIRECTIONAL | G_BINDING_SYNC_CREATE);
  gtk_widget_set_tooltip_text (button, _("Select this option to use symbolic icons instead of regular ones."));
  gtk_widget_set_hexpand (button, TRUE);
