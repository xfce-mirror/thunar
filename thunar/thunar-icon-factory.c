...
thunar_icon_factory_load_file_icon (ThunarIconFactory  *factory,
                                    ...
                                    gint                icon_size)
{
  return thunar_icon_factory_load_file_icon2 (factory, file, icon_state, icon_size, FALSE);
}
 ...
 **/
GdkPixbuf*
thunar_icon_factory_load_file_icon2 (ThunarIconFactory  *factory,
                                     ThunarFile         *file,
                                     ThunarFileIconState icon_state,
                                     gint                icon_size,
                                     gboolean            wants_symbolic)
