...
#define THUNAR_TYPE_ACTION_MANAGER            (thunar_action_mgr_get_type ())
...
GType               thunar_action_mgr_get_type                           (void) G_GNUC_CONST;
void                thunar_action_mgr_activate_selected_files            (ThunarActionManager                 *action_mgr,
...
void                thunar_action_mgr_set_widget                         (ThunarActionManager                 *action_mgr,
                                                                          GtkWidget                           *widget);
GtkWidget          *thunar_action_mgr_get_widget                         (ThunarActionManager                 *action_mgr);
void                thunar_action_mgr_append_accelerators                (ThunarActionManager                 *action_mgr,
                                                                          GtkAccelGroup                       *accel_group);
GtkWidget          *thunar_action_mgr_append_menu_item                   (ThunarActionManager                 *action_mgr,
                                                                          GtkMenuShell                        *menu,
                                                                          ThunarActionManagerAction            action,
                                                                          gboolean                             force);
gboolean            thunar_action_mgr_append_open_section                (ThunarActionManager                 *action_mgr,
                                                                          GtkMenuShell                        *menu,
                                                                          gboolean                             support_tabs,
                                                                          gboolean                             support_change_directory,
                                                                          gboolean                             force);
gboolean            thunar_action_mgr_append_custom_actions              (ThunarActionManager                 *action_mgr,
                                                                          GtkMenuShell                        *menu);
gboolean            thunar_action_mgr_check_uca_key_activation           (ThunarActionManager                 *action_mgr,
                                                                          GdkEventKey                         *key_event);
void                thunar_action_mgr_action_mount                       (ThunarActionManager                 *action_mgr);
gboolean            thunar_action_mgr_action_unmount                     (ThunarActionManager                 *action_mgr);
gboolean            thunar_action_mgr_action_eject                       (ThunarActionManager                 *action_mgr);
void                thunar_action_mgr_set_selection                      (ThunarActionManager                 *action_mgr,
                                                                          GList                               *selected_thunar_files,
                                                                          ThunarDevice                        *selected_device,
                                                                          GFile                               *selected_location);
gboolean            thunar_action_mgr_action_empty_trash                 (ThunarActionManager                 *action_mgr);
gboolean            thunar_action_mgr_action_restore                     (ThunarActionManager                 *action_mgr);
gboolean            thunar_action_mgr_action_restore_and_show            (ThunarActionManager                 *action_mgr);
void                thunar_action_mgr_set_searching                      (ThunarActionManager                 *action_mgr,
                                                                          gboolean                             b);
XfceGtkActionEntry *thunar_action_mgr_get_action_entries                 (void);
