                                      ...
                                      GList           *selected_items)
{
  ...
  gchar             *display_name_string      = NULL;
  gchar             *size_string              = NULL;
  ...
  if (selected_items == NULL) /* nothing selected */
  ...
  else if (selected_items->next == NULL) /* only one item selected */
    {
      ...
      if (show_display_name == TRUE)
        {
          display_name_string = g_strdup_printf (_("\"%s\""), thunar_file_get_display_name (file));
          text_list = g_list_append (text_list, display_name_string);
        }
