...
thunar_context_menu_order_editor_init (ThunarContextMenuOrderEditor *menu_editor)
{
  ...
  /* store */
  menu_editor->store = xfce_item_list_store_new (-1);
  g_object_set (menu_editor, "model", menu_editor->store, NULL);
  g_object_unref (menu_editor->store); /* "menu_editor" now owns the "store" */
  ...
  g_object_set (menu_editor->store,
                "list-flags",
                ...
                NULL);
  g_signal_connect_swapped (menu_editor->store, "before-move-item", G_CALLBACK (thunar_context_menu_order_editor_move), menu_editor);
  g_signal_connect_swapped (menu_editor->store, "activity-changed", G_CALLBACK (thunar_context_menu_order_editor_set_visibility), menu_editor);
  ...
  g_signal_connect_swapped (menu_editor->store, "reset", G_CALLBACK (thunar_context_menu_order_editor_reset), menu_editor);
...
thunar_context_menu_order_editor_show (GtkWidget *window)
{
  ...
  menu_editor = g_object_new (THUNAR_TYPE_CONTEXT_MENU_ORDER_EDITOR, NULL);
