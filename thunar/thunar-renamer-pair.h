...
int                thunar_renamer_pair_comparator_ascending  (const void *pair_a, const void *pair_b);
int                thunar_renamer_pair_comparator_descending (const void *pair_a, const void *pair_b);
