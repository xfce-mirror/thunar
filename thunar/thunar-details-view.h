...
typedef enum
{
  ...
  THUNAR_DETAILS_VIEW_ACTION_ARRANGE_ITEMS_MENU,
  THUNAR_DETAILS_VIEW_ACTION_SORT_BY_NAME,
  THUNAR_DETAILS_VIEW_ACTION_SORT_BY_SIZE,
  THUNAR_DETAILS_VIEW_ACTION_SORT_BY_TYPE,
  THUNAR_DETAILS_VIEW_ACTION_SORT_BY_MTIME,
  THUNAR_DETAILS_VIEW_ACTION_SORT_BY_PREVIOUS,
  THUNAR_DETAILS_VIEW_ACTION_SORT_ASCENDING,
  THUNAR_DETAILS_VIEW_ACTION_SORT_DESCENDING,
