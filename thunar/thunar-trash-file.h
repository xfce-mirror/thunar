...
#define THUNAR_TRASH_FILE_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((obj), THUNAR_TYPE_TRASH_FILE, ThunarTrashFileClass))
#define THUNAR_IS_TRASH_FILE(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), THUNAR_TYPE_TRASH_FILE))
#define THUNAR_IS_TRASH_FILE_CLASS(klass) (G_TYPE_INSTANCE_GET_CLASS ((obj), THUNAR_TYPE_TRASH_FILE, ThunarTrashFileClass))
