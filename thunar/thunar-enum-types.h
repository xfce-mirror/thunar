 ...
 **/
#define THUNAR_TYPE_FILE_DRAG_MODE (thunar_file_drag_mode_get_type ())

/**
 * ThunarFileDragMode:
 * @THUNAR_FILE_DRAG_MODE_DISABLED,          : dnd is disabled for files
 * @THUNAR_FILE_DRAG_MODE_MENU_CONDITIONAL,  : only use DND menu for right click DND
 * @THUNAR_FILE_DRAG_MODE_MENU_ALWAYS,       : always show the DND menu when files are dragged
 **/
typedef enum
{
  THUNAR_FILE_DRAG_MODE_DISABLED,
...
#define THUNAR_TYPE_CONTEXT_MENU_ITEM (thunar_context_menu_item_get_type ())

typedef enum
{
  THUNAR_CONTEXT_MENU_ITEM_OPEN,
  THUNAR_CONTEXT_MENU_ITEM_EXECUTE,
  THUNAR_CONTEXT_MENU_ITEM_EDIT_LAUNCHER,
  THUNAR_CONTEXT_MENU_ITEM_OPEN_IN_TAB,
  THUNAR_CONTEXT_MENU_ITEM_OPEN_IN_WINDOW,
  THUNAR_CONTEXT_MENU_ITEM_OPEN_LOCATION,
  THUNAR_CONTEXT_MENU_ITEM_OPEN_WITH_OTHER,
  THUNAR_CONTEXT_MENU_ITEM_SET_DEFAULT_APP,
  THUNAR_CONTEXT_MENU_ITEM_SENDTO_MENU,
  THUNAR_CONTEXT_MENU_ITEM_SENDTO_SHORTCUTS,
  THUNAR_CONTEXT_MENU_ITEM_SENDTO_DESKTOP,
  THUNAR_CONTEXT_MENU_ITEM_PROPERTIES,
  THUNAR_CONTEXT_MENU_ITEM_MAKE_LINK,
  THUNAR_CONTEXT_MENU_ITEM_DUPLICATE,
  THUNAR_CONTEXT_MENU_ITEM_RENAME,
  THUNAR_CONTEXT_MENU_ITEM_EMPTY_TRASH,
  THUNAR_CONTEXT_MENU_ITEM_REMOVE_FROM_RECENT,
  THUNAR_CONTEXT_MENU_ITEM_CREATE_FOLDER,
  THUNAR_CONTEXT_MENU_ITEM_CREATE_DOCUMENT,
  THUNAR_CONTEXT_MENU_ITEM_RESTORE,
  THUNAR_CONTEXT_MENU_ITEM_RESTORE_SHOW,
  THUNAR_CONTEXT_MENU_ITEM_MOVE_TO_TRASH,
  THUNAR_CONTEXT_MENU_ITEM_DELETE,
  THUNAR_CONTEXT_MENU_ITEM_PASTE,
  THUNAR_CONTEXT_MENU_ITEM_PASTE_INTO_FOLDER,
  THUNAR_CONTEXT_MENU_ITEM_PASTE_LINK,
  THUNAR_CONTEXT_MENU_ITEM_COPY,
  THUNAR_CONTEXT_MENU_ITEM_CUT,
  THUNAR_CONTEXT_MENU_ITEM_MOUNT,
  THUNAR_CONTEXT_MENU_ITEM_UNMOUNT,
  THUNAR_CONTEXT_MENU_ITEM_EJECT,
  THUNAR_CONTEXT_MENU_ITEM_ZOOM_IN,
  THUNAR_CONTEXT_MENU_ITEM_ZOOM_OUT,
  THUNAR_CONTEXT_MENU_ITEM_ZOOM_RESET,
  THUNAR_CONTEXT_MENU_ITEM_CUSTOM_ACTION,
  THUNAR_CONTEXT_MENU_ITEM_ARRANGE_ITEMS,
  THUNAR_CONTEXT_MENU_ITEM_CONFIGURE_COLUMNS,
  THUNAR_CONTEXT_MENU_ITEM_TOGGLE_EXPANDABLE_FOLDERS,
  THUNAR_CONTEXT_MENU_ITEM_SEPARATOR,
  N_THUNAR_CONTEXT_MENU_ITEM,
