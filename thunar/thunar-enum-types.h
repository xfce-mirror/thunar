...
typedef enum
{
  ...
  THUNAR_ICON_SIZE_2048  = 2048,
  THUNAR_ICON_SIZE_4096  = 4096,
} ThunarIconSize;
 ...
 * @THUNAR_THUMBNAIL_XXX_LARGE   : max 2048px x 2048px
 * @THUNAR_THUMBNAIL_XXXX_LARGE  : max 4096px x 4096px
 **/
typedef enum
{
  ...
  THUNAR_THUMBNAIL_SIZE_XXX_LARGE,
  THUNAR_THUMBNAIL_SIZE_XXXX_LARGE,
...
typedef enum
{
  ...
  THUNAR_ZOOM_LEVEL_3200_PERCENT,
  THUNAR_ZOOM_LEVEL_6400_PERCENT,
