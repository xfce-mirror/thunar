...
typedef enum
{
  THUNAR_DATE_STYLE_SIMPLE = 1,
  THUNAR_DATE_STYLE_SHORT,
  THUNAR_DATE_STYLE_LONG,
  THUNAR_DATE_STYLE_LONG_SIMPLE,
  THUNAR_DATE_STYLE_LONG_SHORT,
  THUNAR_DATE_STYLE_YYYYMMDD,
  THUNAR_DATE_STYLE_YYYYMMDD_SIMPLE,
  THUNAR_DATE_STYLE_YYYYMMDD_SHORT,
  THUNAR_DATE_STYLE_MMDDYYYY,
  THUNAR_DATE_STYLE_MMDDYYYY_SIMPLE,
  THUNAR_DATE_STYLE_MMDDYYYY_SHORT,
  THUNAR_DATE_STYLE_DDMMYYYY,
  THUNAR_DATE_STYLE_DDMMYYYY_SIMPLE,
  THUNAR_DATE_STYLE_DDMMYYYY_SHORT,
  THUNAR_DATE_STYLE_CUSTOM,
  THUNAR_DATE_STYLE_CUSTOM_SIMPLE,
  THUNAR_DATE_STYLE_CUSTOM_SHORT
} ThunarDateStyle;

GType thunar_date_style_get_type (void) G_GNUC_CONST;
gboolean thunar_date_style_is_simple (ThunarDateStyle date_style);
gboolean thunar_date_style_is_short (ThunarDateStyle  date_style);
